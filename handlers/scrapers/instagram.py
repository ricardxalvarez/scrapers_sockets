...
class Instagram():
    ...
    def auth(self, username: str, password: str):
        try:
            ...
            time.sleep(float(decimal.Decimal(random.randrange(13, 14))))
    ...
    def scrape_followers(self):
        try:
            ...
            try:
                browser.find_element_by_xpath(
                    '/html/body/div[1]/div/div/div/div[1]/div/div/div/div[1]/div[1]/div[1]/div/div/div/div[2]/div[8]/div/div/a').click()
            except NoSuchElementException:
                try:
                    browser.find_element_by_xpath(
                        '/html/body/div[1]/div/div/div/div[1]/div/div/div/div[1]/div[1]/div[1]/div/div/div/div/div[2]/div[8]/div/div/a').click()
                except NoSuchElementException:
                    browser.find_element_by_xpath(
                        '/html/body/div[2]/div/div/div/div[1]/div/div/div/div[1]/div[1]/div[1]/div/div/div/div/div[2]/div[8]/div/div/a').click()

            time.sleep(float(decimal.Decimal(random.randrange(15, 17))))
            time.sleep(float(decimal.Decimal(random.randrange(15, 17))))
    ...
    #         # finds and opens followers list
            ...
            time.sleep(float(decimal.Decimal(random.randrange(10, 15))))
            is_scrolling = True
            ...
            while is_scrolling:
                ...
                for i in followers:
                    try:
                        ...
                        element = i.find_element_by_xpath(
                            ".//div[2]/div[1]/div/div/div/span/a")
    ...
    def scrape_following(self):
        try:
            ...
            try:
                ...
                not_changed = 0
                loops_count = 0
                time.sleep(float(decimal.Decimal(random.randrange(10, 13))))
                while is_scrolling:
                    if (not_changed == 2):
                        break
                    time.sleep(float(decimal.Decimal(random.randrange(3, 4))))
        ...
        try:
            ...
            try:
                ...
                for follower in self.users:
                    ...
                    time.sleep(float(decimal.Decimal(random.randrange(4, 7))))
                    ...
                    for user in users:
                        ...
                        if (username == follower):
                            ...
                            time.sleep(
                                float(decimal.Decimal(random.randrange(4, 6))))
                            ...
                            time.sleep(
                                float(decimal.Decimal(random.randrange(1, 2))))
